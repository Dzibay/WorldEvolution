...
CARRYING_CAPACITY_FACTOR = 10000
...
# --- Миграция ---
CELL_CAPACITY_SCALE = 2000   # Вместимость клетки (сколько людей может комфортно жить)
...
MAX_GROUPS = 5000
# Логика миграции
MIGRATION_IMMUNITY_STEPS = 25     # 150 лет "иммунитета" у новых групп
MIGRATION_STRESS_THRESHOLD = 0.8  # Порог для миграции племен/городов (голод/перенаселение)

# --- Политика ---
# Порог населения для основания "племени"
TRIBE_FOUNDING_THRESHOLD = 100
# Порог населения для "города"
CITY_FOUNDING_THRESHOLD = 7000
# Порог населения, технологий для "Государства"
STATE_FOUNDING_POP = 30000
STATE_FOUNDING_TECH = 0.3

# --- Технологии ---
# Шанс на "прорыв" в технологии за шаг (на группу)
TECH_DISCOVERY_CHANCE_BASE = 0.0001
# Как сильно плотность населения влияет на открытия
TECH_DENSITY_FACTOR = 0.4
...
# Логика мореплавания
SEAFARING_TECH_THRESHOLD = 0.1    # Технология для постройки лодок
